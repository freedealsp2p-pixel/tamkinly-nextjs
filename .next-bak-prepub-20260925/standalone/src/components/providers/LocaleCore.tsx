...
// Performance split (2026-09-18): the two message JSON files used to be
// imported statically HERE, bundling BOTH locales (~471KB raw / 134KB gz)
// into a single client chunk downloaded by every visitor.
// LocaleCore now receives the single-locale messages as a prop;
// LocaleProviderEn / LocaleProviderAr each bundle exactly one locale,
// and LocaleProvider.tsx loads only the bundle matching the request locale.
...
export function LocaleCore({ messages, children, initialLocale = 'en', urlBased = false }: LocaleCoreProps) {
