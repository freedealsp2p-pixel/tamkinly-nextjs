...
const searchableContent = [
  ...
  // Products
  { title: 'Basic (Monthly)', titleAr: 'أساسي (شهري)', path: '/products/basic', type: 'product', description: '7-day discipline journey starter', descriptionAr: 'بداية رحلة الانضباط لـ 7 أيام', keywords: ['basic', '7-day', 'starter'] },
  { title: 'Premium (Monthly)', titleAr: 'مميز (شهري)', path: '/products/premium', type: 'product', description: 'Complete 30-day transformation system', descriptionAr: 'نظام تحول كامل لمدة 30 يوم', keywords: ['premium', '30-day', 'recode'] },
  ...
  { title: 'Mastery (Monthly)', titleAr: 'إتقان (شهري)', path: '/products/mastery', type: 'product', description: 'All apps + AI Coach + Community', descriptionAr: 'كل التطبيقات + مدرب AI + المجتمع', keywords: ['mastery', 'complete', 'all'] },
  
  // Recovery - TRC (Trauma Recovery Center)
  { title: 'Trauma Recovery Center', titleAr: 'مركز التعافي من الصدمات', path: '/recovery/trc', type: 'app', description: 'Evidence-based trauma recovery tools and resources', descriptionAr: 'أدوات وموارد للتعافي من الصدمات مبنية على الأدلة', keywords: ['trauma', 'recovery', 'trc', 'صدمة', 'تعافي'] },
  { title: 'Sensory Grounding 5-4-3-2-1', titleAr: 'تنظم الحواس 5-4-3-2-1', path: '/recovery/trc/grounding', type: 'app', description: '5-4-3-2-1 sensory grounding technique for nervous system regulation', descriptionAr: 'تقنية تنظم الحواس لتنظيم الجهاز العصبي', keywords: ['grounding', 'sensory', 'anxiety', 'تنظم', 'حواس'] },
  { title: 'A52 Combat Breathing', titleAr: 'تنفس A52 القتالي', path: '/recovery/trc/a52', type: 'app', description: 'Military combat breathing technique for anxiety and panic', descriptionAr: 'تقنية تنفس عسكرية للقلق والهلع', keywords: ['breathing', 'a52', 'anxiety', 'تنفس', 'قلق'] },
  { title: 'Safe Place Visualization', titleAr: 'المكان الآمن', path: '/recovery/trc/safe-place', type: 'app', description: 'Guided safe place visualization for deep regulation', descriptionAr: 'تخيل المكان الآمن للتنظيم العميق', keywords: ['visualization', 'safe', 'regulation', 'مكان', 'آمن'] },
  { title: 'Guided Body Scan', titleAr: 'مسح الجسد', path: '/recovery/trc/body-scan', type: 'app', description: 'Guided body scan meditation for trauma awareness', descriptionAr: 'تأمل مسح الجسد للوعي بالصدمة', keywords: ['body', 'scan', 'meditation', 'جسد', 'مسح'] },
  { title: 'What Trauma Does to the Body', titleAr: 'ماذا تفعل الصدمة بالجسد', path: '/recovery/trc/what-trauma-does-to-the-body', type: 'article', description: 'Understanding how trauma affects the body and nervous system', descriptionAr: 'فهم كيف تؤثر الصدمة على الجسد والجهاز العصبي', keywords: ['trauma', 'body', 'psychoeducation', 'صدمة', 'جسد'] },
  { title: 'Trauma Response Patterns', titleAr: 'أنماط استجابة الصدمة', path: '/recovery/trc/what-happens-during-trauma-responses', type: 'article', description: 'Understanding fight, flight, freeze, fawn trauma responses', descriptionAr: 'فهم استجابات الصدمة: قتال، هرب، تجميد، استسلام', keywords: ['trauma', 'responses', 'fight', 'flight', 'freeze', 'صدمة', 'استجابة'] },
  { title: 'Trigger Mapping', titleAr: 'خريطة المحفزات', path: '/recovery/trc/worksheets/trigger-mapping', type: 'app', description: 'Map your personal trauma triggers and responses', descriptionAr: 'خريطة محفزات الصدمة الشخصية واستجاباتك', keywords: ['triggers', 'mapping', 'worksheet', 'محفزات', 'خريطة'] },
  { title: 'Safety Plan', titleAr: 'خطة الأمان', path: '/recovery/trc/worksheets/safety-plan', type: 'app', description: 'Create a personal safety plan for crisis moments', descriptionAr: 'إنشاء خطة أمان شخصية للحظات الأزمة', keywords: ['safety', 'plan', 'crisis', 'أمان', 'خطة'] },
  { title: 'Regulation Toolkit', titleAr: 'أدوات التنظيم', path: '/recovery/trc/regulation-toolkit', type: 'app', description: 'Nervous system regulation toolkit with personalized tool recommendations', descriptionAr: 'مجموعة أدوات لتنظيم الجهاز العصبي مع اقتراحات شخصية', keywords: ['regulation', 'toolkit', 'nervous', 'تنظيم', 'أدوات'] },
  { title: 'Regulation Guide', titleAr: 'دليل التنظيم', path: '/recovery/trc/regulation-guide', type: 'article', description: 'Understanding the window of tolerance and regulation', descriptionAr: 'فهم نافذة التحمل والتنظيم', keywords: ['regulation', 'guide', 'tolerance', 'تنظيم', 'دليل'] },
  { title: 'TRC Downloads', titleAr: 'تنزيلات TRC', path: '/recovery/trc/downloads', type: 'page', description: 'Downloadable trauma recovery worksheets and resources', descriptionAr: 'أوراق عمل وموارد للتعافي من الصدمات للتنزيل', keywords: ['downloads', 'worksheets', 'trc', 'تنزيلات', 'أوراق'] },

  // Recovery - Porn Recovery
  { title: 'Porn Recovery', titleAr: 'التعافي من الأنماط القهرية', path: '/recovery/porn-recovery', type: 'app', description: 'Evidence-based recovery from compulsive sexual patterns', descriptionAr: 'التعافي من الأنماط القهرية مبني على الأدلة', keywords: ['porn', 'recovery', 'compulsive', 'تعافي', 'قهري'] },
