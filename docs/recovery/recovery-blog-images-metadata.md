# Recovery Blog Images — Metadata Reference (2026-09-22)

13 صورة أعُدّت لقسم التعافي. الملفات مرفوعة في /uploads/articles/ بالأسماء النهائية (1376x768 webp).
المقالان المنشوران (porn-recovery-roadmap، trauma-recovery-three-stages) دُمجت فيهما صورهما:
Registry image + BlogArticleJsonLd image + ArticleFigure داخل المحتوى.
عند بناء أي مقال من الـ 11 المتبقية استخدم الحقول أدناه داخل <ArticleFigure> + registry image + JSON-LD image.

ملاحظات إلزامية عند النشر:
- المقال 8 (paced-breathing-for-regulation): في meta description استخدم «العصب المبهم» لا «العصب الحائر» (تصحيح معتمد).
- المقال 13 (trauma-journaling-integration): Meta Title لا يجوز أن يتضمن «اكتب لتتماكى» (خطأ لغوي مرصود) — صياغة سليمة بديلة عند النشر.
