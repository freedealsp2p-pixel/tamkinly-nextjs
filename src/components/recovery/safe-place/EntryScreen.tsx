      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="flex justify-center">
          <div className="w-16 h-16 rounded-full bg-[#1F6F78]/10 flex items-center justify-center">
            <Shield className="w-8 h-8 text-[#1F6F78]" />
          </div>
        </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800 leading-relaxed max-w-sm mx-auto">
          ...
          <p>
            {direction === 'rtl'
              ? 'إذا كنت تعاني من تفارق حاد أو ذكريات اقتحامية حية، قد لا يكون هذا التمرين مناسباً الآن. يمكنك تجربة تنظم الحواس 5-4-3-2-1 بدلاً.'
              : 'If you experience severe dissociation or active flashbacks, this exercise may not be suitable right now. You can try 5-4-3-2-1 Sensory Grounding instead.'}
          </p>
          {direction === 'rtl' ? (
