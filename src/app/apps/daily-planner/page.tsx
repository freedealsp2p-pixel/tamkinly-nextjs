    ...
    <div className="min-h-screen bg-[#F6F8FA]">
      <div className="bg-gradient-to-br from-[#0F1C2E] via-[#0F1C2E] to-[#1F6F78] text-white py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">30-Day Identity Planner</h1>
          <p className="text-lg text-slate-300">Interactive 30-day planner with identity prompts, non-negotiable actions, and evidence tracking.</p>
        </div>
      </div>
        ...
        <Card className="border-2 border-[#3DD4B0]/30 shadow-lg mb-8">
          ...
          <CardContent className="text-center">
            <div className="space-y-4 mb-6">
              {['30-day interactive planner', 'Daily identity prompts', 'Progress tracking', 'Printable PDF version'].map((f, i) => (
