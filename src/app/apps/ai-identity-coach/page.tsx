          ...
          <div className="flex items-center gap-3 mt-2">
            ...
            <div>
              <div className="flex items-center gap-2">
                <Badge className="bg-[#0F1C2E] text-[#3DD4B0] border border-[#3DD4B0]/50">BUNDLE</Badge>
        ...
        <Card className="bg-white mb-8 overflow-hidden">
          ...
          <CardContent className="p-8 lg:p-12 text-center">
            ...
            <h2 className="font-serif text-3xl font-bold text-[#0F1C2E] mb-4">
              AI Identity Coach is Under Development
            </h2>
            
            <p className="text-lg text-slate-600 max-w-2xl mx-auto mb-8">
              We're working hard to bring you an intelligent coaching experience powered by 
              evidence-based psychology frameworks. This feature will be available soon for 
              BUNDLE package subscribers.
            </p>
        ...
        <Card className="bg-white mb-8">
          <CardContent className="p-6 lg:p-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                { title: 'Identity Discovery', desc: 'Guided conversations to explore who you are and who you want to become' },
                { title: 'Habit Formation', desc: 'Identity-based habit strategies backed by behavioral science' },
                { title: 'Self-Authorship', desc: 'Develop your internal voice and move beyond external formulas' },
                { title: 'Emotion Regulation', desc: 'Learn cognitive reappraisal and emotional intelligence techniques' },
              ].map((feature, index) => (
