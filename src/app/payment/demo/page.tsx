...
function DemoPaymentContent() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0F1C2E] to-[#1F6F78] flex items-center justify-center p-4">
        <Card className="max-w-md w-full border-0 shadow-2xl">
          <CardContent className="p-8 text-center">
            <div className="w-20 h-20 rounded-full bg-green-100 flex items-center justify-center mx-auto mb-6">
              <CheckCircle2 className="w-10 h-10 text-green-600" />
            </div>
            <h1 className="text-2xl font-bold text-[#0F1C2E] mb-2">Payment Successful!</h1>
            <p className="text-slate-600 mb-4">Redirecting to confirmation page...</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0F1C2E] to-[#1F6F78] py-8 px-4">
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300">Secure Payment Gateway</p>
        </div>
        ...
        <Card className="border-0 shadow-lg mb-6">
          <CardContent className="p-6">
            <h3 className="font-semibold text-[#0F1C2E] mb-4">Payment Method</h3>
          ...
          <Card className="border-0 shadow-lg mb-6">
            <CardContent className="p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xs text-slate-500">Secure payment powered by Tahweel</span>
              </div>
              ...
              <div className="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-xs text-blue-700">
                  <strong>Demo Mode:</strong> This is a test payment. Use card 4242 4242 4242 4242 with any future expiry date.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg mb-6">
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-[#0F1C2E] mb-2">Bank Transfer Details</h3>
                ...
                <div className="bg-slate-50 p-4 rounded-lg text-left space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">Demo Bank</span>
                  </div>
                  <div className="flex justify-between">
