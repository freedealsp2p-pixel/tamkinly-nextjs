...
import { SEO_SITE_CONFIG, PAGE_METADATA, HOME_METADATA, generatePageMetadataFromConfig } from "@/lib/seo-pages";
...
export async function generateMetadata(): Promise<Metadata> {
  const locale = await getLocaleFromCookies();
    // Home metadata via generatePageMetadataFromConfig
  return {
    ...generatePageMetadataFromConfig('home', locale),
  ...
  return (
    <html lang={locale} dir={locale === 'ar' ? 'rtl' : 'ltr'}>
      <head>
        ...
        {/* WebSite JSON-LD — single instance on every page */}
        <script
