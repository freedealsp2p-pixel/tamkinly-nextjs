...
export default function CategoriesPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      setNotification(editingId ? 'Category updated!' : 'Category created!');
      resetForm();
      fetchCategories();
    } catch (err: any) {
    ...
    <div>
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    formActive ? 'bg-[#3DD4B0]' : 'bg-slate-300'
                  }`}
                >
                  <span
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white rounded-xl border border-slate-200">
          ...
          <h3 className="text-lg font-medium text-slate-700">No categories yet</h3>
          <p className="text-sm text-slate-500 mt-1">Create your first category to organize content.</p>
          <button
            onClick={openAddForm}
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
            ...
            <p className="text-sm text-slate-600 mb-6">
              Are you sure you want to delete this category? Articles in this category will not be deleted.
            </p>
