        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-serif text-2xl sm:text-3xl font-bold text-white mb-4">
              {getText("Liberate Your True Identity", "حرر هويتك الحقيقية")}
            </h2>
            <p className="text-slate-300 mb-6">
              {getText("Get the tools to shed what's not you and become who you were born to be.", "احصل على الأدوات للتخلص مما لست أنت وتصبح من ولدت لتكونه.")}
            </p>
            <Link href="/products">
