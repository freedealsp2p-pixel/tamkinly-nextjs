...
import { getCategoryBySlug, getArticlesForCategory, getAllCategorySlugs, BLOG_CATEGORIES } from '@/lib/blog-articles';
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        {articles.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-semibold text-slate-600 mb-2">No articles yet</h3>
            <p className="text-slate-400">Check back soon for new content in this category.</p>
          </div>
        )}
      </section>
      ...
      <section className="bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <h2 className="text-2xl font-serif font-bold text-slate-900 mb-8">Browse All Categories</h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-slate-400">{otherCount} articles</p>
                  </div>
