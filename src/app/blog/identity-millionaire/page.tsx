        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-serif text-2xl sm:text-3xl font-bold text-white mb-4">
              {getText("Transform Your Identity. Transform Your Wealth.", "حوّل هويتك. حوّل ثروتك.")}
            </h2>
            <p className="text-slate-300 mb-6">
              {getText("Get the frameworks to become the person who creates lasting abundance.", "احصل على الأطر لتصبح الشخص الذي يخلق الوفرة الدائمة.")}
            </p>
            <Link href="/products">
