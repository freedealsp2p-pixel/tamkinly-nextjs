          ...
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <p className="text-xl text-slate-600 leading-relaxed mb-8 font-medium">
              {getText(
                ...
                "دماغك ليس أداة للتفكير. إنه محرك تنبؤ. وظيفته الأساسية ليست التأمل أو التفكّر — بل التنبؤ بما ستفعله بعد ذلك، وإبقائك داخل منطقة الأمان. كل عادة لديك، كل نمط تكرره، كل مقاومة تشعر بها عندما تحاول التغيير — كل ذلك هو دماغك يُشغّل نموذجاً تنبؤياً مصمماً لشيء واحد: البقاء من خلال الألفة."
              )}
            </p>
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              {getText(
                ...
                "عندما تجد نفسك تماطل، لكس هذا كسلاً. إنها استراتيجية دفاعية من دماغك للحفاظ على الاستقرار السلوكي. أبحاث فلايف ودولان تُظهر أن الدماغ يميل باستمرار إلى تفضيل السياق الحالي على الأهداف المستقبلية البعيدة. المماطلة هي طريقة جهازك العصبي للقول: لننبق مع السلوك الذي نعرف عواقبه، بدلاً من المخاطرة بسلوك لا نعرف نتائجه. المألوف — حتى لو كان عادة مدمرة — يشعر دائماً بالأمان أكثر من غير المألوف. لأن المألوف يتطلب طاقة أقل. لأن المألوف قابل للتنبؤ. لأن المألوف مرسوم بالفعل في بنيتك العصبية."
              )}
            </p>
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              {getText(
                ...
                "لهذا تفشل الإرادة. قيل لنا أن التغيير يتطلب إرادة حديدية، لكن العلم الحديث يكشف أن الإرادة مورد محدود — بطارية تنفد مع كل قرار، وكل مقاومة، وكل اختيار قسري. السر الحقيقي ليس في محاربة الدماغ، بل في فهم لغته التنبؤية واختراقها. عندما تحوّل الإدراك الواعي إلى سياق بيئي محفّز، يصبح النجاح عملية تلقائية لا تتطلب جهداً ذهنياً مستمراً. السؤال ليس كيف تجبر نفسك على التغيير. السؤال هو كيف تجعل الدماغ يريد التغيير بجعل السلوك الجديد يشعر بالأمان أكثر من القديم."
              )}
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/apps/identity-recode-system-guide">
