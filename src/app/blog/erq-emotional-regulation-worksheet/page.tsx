        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-serif text-2xl sm:text-3xl font-bold text-white mb-4">
              {getText("Master Your Emotional Regulation", "أتقن تنظيم مشاعرك")}
            </h2>
            <p className="text-slate-300 mb-6">
              {getText("Get the complete ERQ worksheet with assessment, exercises, and development tools.", "احصل على ورقة عمل ERQ الكاملة مع التقييم والتمارين وأدوات التطوير.")}
            </p>
